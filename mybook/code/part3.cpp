...
void my_boxFilter()
{
	...
	cvCreateTrackbar("boxFilter_element", "boxFilter", &boxFilter_size, 50);//创建一个滑动条，用以调整滤波的算子大小
...
void my_blur()
{
	...
	cvCreateTrackbar("blur_element", "blur", &blur_size, 50);//创建一个滑动条，用以调整滤波的算子大小
...
void my_GaussianBlur()
{
	...
	cvCreateTrackbar("GaussianBlur_element", "GaussianBlur", &GaussianBlur_size, 50);//创建一个滑动条，用以调整滤波的算子大小
...
void my_medianBlur()
{
	...
	cvCreateTrackbar("medianBlur_element", "medianBlur", &medianBlur_size, 50);//创建一个滑动条，用以调整滤波的算子大小
...
void my_bilateralBlur()
{
	...
	cvCreateTrackbar("bilateralBlur_element", "bilateralBlur", &bilateral_size, 50);//创建一个滑动条，用以调整滤波的算子大小
